...
public class AzureSpatialAnchorsScript : MonoBehaviour
{
    ...
    /// <summary>
    /// Ajout de l'ARAnchorManager pour le prefab à instancier
    /// </summary>
    ...
    private async Task CreateAnchor(Vector3 position)
    {
        ...
        //GameObject anchorGameObject = _arAnchorManager.anchorPrefab;
        //GameObject anchorGameObject = Instantiate(_spatialAnchorManager.m_AnchorPrefab, position, orientationTowardsHead);
